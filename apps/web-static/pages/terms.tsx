        ...
        <Layout.BodyContent isError={false} isLoading={false}>
          <Container>
            ...
            <p className="text-gray-500 mt-2">
              ...
              Gogo App (&apos;Company&apos;, &apos;we&apos;, &apos;us&apos;, or
              &apos;our&apos;), a company registered in India.
            </p>

            <p className="text-gray-500 mt-2">
              We operate the mobile application Gogo App (the &apos;App&apos;),
            ...
            <div>
              ...
              <p className="text-gray-500 mt-2">
                ...
                other works, your Contributions, and to sublicence the licences
              ...
              <p className="text-gray-500 mt-2">
                ...
                <br /> (1) all registration information you submit will be true,
                ...
                <br /> (4) you are not a minor in the jurisdiction in which you
                reside, or if a minor, you have received parental permission to
                use the Services;
                <br /> (5) you will not access the Services through automated or
              ...
              <p className="text-gray-500 mt-2">
                ...
                the actual colours and details of the products. All products are
              ...
              <h3 className="text-md font-bold mb-4 mt-8">7. RETURN POLICY</h3>
              <p className="text-gray-500 mt-2">
              ...
              <p className="text-gray-500 mt-2">
                ...
                and grant and authorise sublicences of the foregoing. The use
              ...
              <p className="text-gray-500 mt-2">
                ...
                assignable, and sublicensable right and licence to reproduce,
              ...
              <p className="text-gray-500 mt-2">
                ...
                any way a substitute for the App;
                <br /> (8) use the App to send automated queries to any website
                or to send any unsolicited commercial email; or
              ...
              <p className="text-gray-500 mt-2">
                ...
                <br /> (1) the licence granted to you for our App is limited to
                a non-transferable licence to use the application on a device
                ...
                <br /> (2) we are responsible for providing any maintenance and
                ...
                <br /> (3) in the event of any failure of the App to conform to
                ...
                <br /> (i) you are not located in a country that is subject to a
              ...
              <p className="text-gray-500 mt-2">
                ...
                advised the Services are hosted in India and India. If you
                ...
                or disclosure that differ from applicable laws in India and
                India, then through your continued use of the Services, you are
                transferring your data to India and India, and you expressly
              ...
              <h3 className="text-md font-bold mb-4 mt-8">18. GOVERNING LAW</h3>
              <p className="text-gray-500 mt-2">
                These Legal Terms shall be governed by and defined following the
                laws of India. CoderDNA Technologies Private Limited and
              ...
              <p className="text-gray-500 mt-2">
                ...
                VIA THE SERVICES. WE DO NOT WARRANT, ENDORSE, GUARANTEE, OR
              ...
              <p className="text-gray-500 mt-2">
                ...
                OF THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE ONE
                <br />
              ...
              <h3 className="text-md font-bold mb-4 mt-8">26. MISCELLANEOUS</h3>
              <p className="text-gray-500 mt-2">
