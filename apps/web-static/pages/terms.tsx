          ...
          <Container>
            <Container>
              ...
              <p className="text-gray-500 mt-2">
                We are CoderDNA Technologies Private Limited, doing business as
                Gogo App (&apos;Company&apos;, &apos;we&apos;, &apos;us&apos;,
                or &apos;our&apos;), a company registered in India.
              </p>

              <p className="text-gray-500 mt-2">
                We operate the mobile application Gogo App (the
              ...
              <p className="text-gray-500 mt-2">
                ...
                (&apos;you&apos;), and CoderDNA Technologies Private Limited,
              ...
              <p className="text-gray-500 mt-2">
                ...
                any changes by updating the &apos;Last updated&apos; date of
                these Legal Terms, and you waive any right to receive specific
              ...
              <div>
                <h3 className="text-md font-bold mb-4 mt-8">1. OUR SERVICES</h3>
                <p className="text-gray-500 mt-2">
                ...
                <h4 className="text-gray-900 mt-4 font-medium">
                ...
                <p className="text-gray-500 mt-2">
                  ...
                  to understand the
                  <br /> (a) rights you give us and
                  <br /> (b) obligations you have when you post or upload any
                ...
                <p className="text-gray-500 mt-2">
                  ...
                  <br /> (a) this section, <br /> (b) any third party&apos;s
                  intellectual property rights, or <br /> (c) applicable law.
                </p>
                <p className="text-gray-500 mt-2">
                ...
                <p className="text-gray-500 mt-2">
                  ...
                  <br /> (1) all registration information you submit will be
                  true, accurate, current, and complete;
                  <br /> (2) you will maintain the accuracy of such information
                  and promptly update such registration information as
                  necessary;
                  <br /> (3) you have the legal capacity and you agree to comply
                  with these Legal Terms;
                  <br /> (4) you are not a minor in the jurisdiction in which
                  you reside, or if a minor, you have received parental
                  permission to use the Services;
                  <br /> (5) you will not access the Services through automated
                  or non-human means, whether through a bot, script or
                  otherwise;
                  <br /> (6) you will not use the Services for any illegal or
                  unauthorised purpose; and
                  <br /> (7) your use of the Services will not violate any
                ...
                <h3 className="text-md font-bold mb-4 mt-8">5. PRODUCTS</h3>
                <p className="text-gray-500 mt-2">
                ...
                <p className="text-gray-500 mt-2">
                  ...
                  accesses the Services, or use or launch any unauthorised
                ...
                <p className="text-gray-500 mt-2">Use Licence</p>
                <p className="text-gray-500 mt-2">
                  ...
                  Terms. You shall not:
                  <br /> (1) except as permitted by applicable law, decompile,
                  ...
                  <br /> (3) violate any applicable laws, rules, or regulations
                  in connection with your access or use of the App;
                  <br /> (4) remove, alter, or obscure any proprietary notice
                  <br /> (including any notice of copyright or trademark) posted
                  by us or the licensors of the App;
                  <br /> (5) use the App for any revenue-generating endeavour,
                  commercial enterprise, or other purpose for which it is not
                  designed or intended;
                  <br /> (6) make the App available over a network or other
                  environment permitting access or use by multiple devices or
                  users at the same time;
                  <br /> (7) use the App for creating a product, service, or
                  software that is, directly or indirectly, competitive with or
                  in any way a substitute for the App;
                  <br /> (8) use the App to send automated queries to any
                  website or to send any unsolicited commercial email; or
                  <br /> (9) use any proprietary information or any of our
                ...
                <p className="text-gray-500 mt-2">Apple and Android Devices</p>
                <p className="text-gray-500 mt-2">
                  ...
                  <br /> (1) the licence granted to you for our App is limited
                  to a non-transferable licence to use the application on a
                  device that utilises the Apple iOS or Android operating
                  systems, as applicable, and in accordance with the usage rules
                  set forth in the applicable App Distributor’s terms of
                  service;
                  <br /> (2) we are responsible for providing any maintenance
                  and support services with respect to the App as specified in
                  ...
                  <br /> (3) in the event of any failure of the App to conform
                  ...
                  <br /> (4) you represent and warrant that
                  <br /> (i) you are not located in a country that is subject to
                  a US government embargo, or that has been designated by the US
                  government as a &apos;terrorist supporting&apos; country and
                  <br /> (ii) you are not listed on any US government list of
                  prohibited or restricted parties;
                  <br /> (5) you must comply with applicable third-party terms
                  of agreement when using the App, e.g. if you have a VoIP
                  application, then you must not be in violation of their
                  wireless data service agreement when using the App; and
                  <br /> (6) you acknowledge and agree that the App Distributors
                  are third-party beneficiaries of the terms and conditions in
                  this mobile application licence contained in these Legal
                  Terms, and that each App Distributor will have the right (and
                ...
                <p className="text-gray-500 mt-2">
                  ...
                  <Link href="/privacy-policy">
                    https://mygogo.app/privacy-policy
                  </Link>
                  . By using the Services, you agree to be bound by our Privacy
                  Policy, which is incorporated into these Legal Terms. Please
                  be advised the Services are hosted in India and India. If you
                  ...
                  and India, then through your continued use of the Services,
                  you are transferring your data to India and India, and you
                  expressly consent to have your data transferred to and
                  processed in India and India.
                </p>
                <h3 className="text-md font-bold mb-4 mt-8">
                ...
                <p className="text-gray-500 mt-2">
                  ...
                  the laws of India. CoderDNA Technologies Private Limited and
                ...
                <p className="text-gray-500 mt-2">
                  ...
                  procedures; and <br />
                  (c) there is no right or authority for any Dispute to be
                ...
                <p className="text-gray-500 mt-2">
                  ...
                  theft, piracy, invasion of privacy, or unauthorised use; and
                  <br />
                ...
                <h3 className="text-md font-bold mb-4 mt-8">20. CORRECTIONS</h3>
                <p className="text-gray-500 mt-2">
                ...
                <h3 className="text-md font-bold mb-4 mt-8">21. DISCLAIMER</h3>
                <p className="text-gray-500 mt-2">
                  ...
                  SERVICES,
                  <br />
                  (3) ANY UNAUTHORISED ACCESS TO OR USE OF OUR SECURE SERVERS
                ...
                <p className="text-gray-500 mt-2">
                  ...
                  LESSER OF THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE ONE
                  <br />
                  (1) MONTH PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING OR RS
                  5000. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT NOT
                ...
                <h3 className="text-md font-bold mb-4 mt-8">24. USER DATA</h3>
                <p className="text-gray-500 mt-2">
                ...
                <h3 className="text-md font-bold mb-4 mt-8">27. CONTACT US</h3>
                <p className="text-gray-500 mt-2">
