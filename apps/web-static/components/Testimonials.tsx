...
const Testimonials = () => {
  return (
    <AnimatePresence>
      <div className="relative isolate bg-white pb-12 pt-24 sm:pt-32">
        <div
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 grid-rows-1 gap-8 text-sm leading-6 text-gray-900 sm:mt-20 sm:grid-cols-2 xl:mx-0 xl:max-w-none xl:grid-flow-col xl:grid-cols-4">
            <div className="col-span-2 hidden sm:block  xl:col-start-2 xl:row-end-1">
              <InViewPort>
                <figure className="sm:bg-white sm:shadow-lg sm:ring-1 sm:ring-gray-900/5 sm:rounded-2xl">
                ...
                {columnGroup.map((column, columnIdx) => (
                  ...
                  >
                    {column.map((testimonial) => (
                      <InViewPort key={testimonial.author.city}>
